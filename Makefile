...
CPU_OBJS = $(OBJ_DIR)/gdt.o $(OBJ_DIR)/gdt_flush.o $(OBJ_DIR)/idt.o $(OBJ_DIR)/idt_load.o \
           ...
           $(OBJ_DIR)/syscall.o $(OBJ_DIR)/syscall_stubs.o \
           $(OBJ_DIR)/tss.o $(OBJ_DIR)/tss_flush.o
...
TASK_INS_OBJS = $(OBJ_DIR)/kthreads_test.o $(OBJ_DIR)/uprocs_test.o $(OBJ_DIR)/init_us.o
